...
![image.png](/assets/img/hackthebox/machines/permx/ttecnologias-web2.png)
...
Si se crea un symlink al fichero `/etc/passwd` se puede utilizar el script [`acl.sh`](http://acl.sh/) para eliminar la contraseña del usuario `root` y obtener acceso:
